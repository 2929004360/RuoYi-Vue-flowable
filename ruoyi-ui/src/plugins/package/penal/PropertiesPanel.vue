  ...
  <div class="process-panel__container" :style="{ width: `${this.width}px` }">
    <el-collapse v-model="activeTab">
      <el-collapse-item name="base">
        ...
        <element-base-info style="height: 200px;" :id-edit-disabled="idEditDisabled"
                           :business-object="elementBusinessObject" :type="elementType"/>
      </el-collapse-item>
      ...
      <el-collapse-item name="button"
                        v-if="elementType.indexOf('Task') !== -1 && ($globalStore.dataType !== 'INITIATOR' && $globalStore.dataType)"
                        key="button">
        <div slot="title" class="panel-tab__title"><i class="el-icon-thumb"></i>按钮</div>
        <element-button :id="elementId" :type="elementType"/>
      </el-collapse-item>
