<template>
  <div class="panel-tab__content">
    <el-form size="mini" label-width="70px" @submit.native.prevent>
      ...
      <el-form-item prop="localScope" label="注意">
        <el-link :underline="false" type="warning">若为节点表单，则表单信息仅在此节点可用，默认为全局表单，表单信息在整个流程实例中可用</el-link>
      </el-form-item>
      <el-form-item prop="localScope" label="节点表单">
