<template>
  <div class="app-container">
    <el-card class="box-card" v-if="processed === true">
    ...
    <el-dialog :title="addSignTitle" @cancel="addSignOpen = false" :visible.sync="addSignOpen" width="40%"
      ...
      <el-form style="margin-top: 10px" ref="addSignForm" :model="addSignForm" label-width="80px">
    ...
    <SelectUser ref="SelectUser" v-model="selectUserList" :allowCancel="true" :isWhole="false"
                :selectType="selectType" @determine="determineUser"></SelectUser>
  </div>
</template>
